...
|---|---|---|---|
| `GET` | `/auth/me/role` | Valid Token | Verifies user's Firebase token, checks role, and returns redirect URL (Client Dashboard, Tailor Dashboard, Admin Console, or Onboarding). |
